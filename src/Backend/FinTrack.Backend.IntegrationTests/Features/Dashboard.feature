...
Funcionalidade: Dashboard Financeiro
  ...
  Cenário: Visualizar dashboard com transações
    Dado que existem as seguintes transações:
      ...
      | Income  | Salary    | 5000  | 2026-05-01 | Salário Janeiro  |
      | Expense | Bills     | 1500  | 2026-05-05 | Aluguel          |
      | Expense | Bills     | 500   | 2026-05-10 | Conta de Luz     |
    Quando eu consulto o dashboard
    Então a requisição deve ser bem-sucedida
    E o total de receitas deve ser 5000
    E o total de despesas deve ser 2000
    E o balanço deve ser 3000

  Cenário: Dashboard com transações excluídas não deve contabilizá-las
    Dado que existem as seguintes transações:
      | Tipo    | Categoria | Valor | Data       | Descrição |
      | Income  | Salary    | 3000  | 2026-05-01 | Salário   |
      | Expense | Bills     | 1000  | 2026-05-05 | Despesa 1 |
    E a transação "Despesa 1" foi excluída
    Quando eu consulto o dashboard
    Então a requisição deve ser bem-sucedida
    E o total de receitas deve ser 3000
    E o total de despesas deve ser 0
    E o balanço deve ser 3000
